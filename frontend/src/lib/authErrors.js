export function authErrorMessage(error) {
  ...
  if (message.includes('password should be at least')) return 'Your password must contain at least 8 characters.'
  if (message.includes('network') || message.includes('fetch')) return 'Unable to reach the service. Check your connection and try again.'
